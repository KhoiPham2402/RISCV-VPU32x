...
# Copy hex file to work directory so $readmemh can find it
file copy -force rtl/counter.hex counter.hex
...
# ===== Run =====
# Waveform: TB writes wave_riscv_vpu.vcd in the simulation working directory.
# Reproducible VRF init: vsim ... +SEED=12345
vsim -voptargs=+acc work.tb_riscv_vpu_top
