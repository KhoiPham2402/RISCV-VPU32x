...
# Copy instruction hex → imem.hex (imem_sync reads "imem.hex" at elaboration)
# Switch commented lines to change benchmark:
file copy -force test_alu.hex imem.hex
...
vlog -sv \
    ...
    bench/tb_riscv_vpu_top_v3.sv

# ===== Simulate =====
vsim -voptargs=+acc work.tb_riscv_vpu_top_v3
