...
# Copy bench_matmul hex so imem_sync's $readmemh("imem.hex") finds it
file copy -force sw/benchmarks/matmul/matmul_imem.hex imem.hex

# ===== TileLink package (compile first — used by trial files) =====
vlog -sv rtl_trial/bus/tl_pkg.sv

# ===== Compile RISC-V scalar primitives (shared cells used by VPU too) =====
vlog -sv \
    rtl/riscv/d_ff.sv \
...
# ===== Compile Testbench =====
vlog -sv bench/tb_riscv_vpu_top_v2.sv

# ===== Run =====
vsim -voptargs=+acc work.tb_riscv_vpu_top_v2
