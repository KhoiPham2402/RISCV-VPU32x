# =============================================================================
# run_sobel_lena.do — Sobel edge detection on Lena, full FPGA system
# DUT: pipelined_vpu + vproc_system_wrapper + dmem_arbiter + dmem_model_sp
# (fpga/rtl), firmware from sw/benchmarks/sobel/ (built via `make` there).
#
# Chạy từ project root: vsim -c -do fpga/sim/run_sobel_lena.do
# =============================================================================
set RTL   fpga/rtl
set IP    fpga/ip
...
vlog -sv $BENCH/tb_sobel_lena.sv

vsim -c -t 1ps work.tb_sobel_lena
run -all
quit -f
